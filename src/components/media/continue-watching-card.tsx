...
export function ContinueWatchingCard({ media, onOpen, onPlay }: Props) {
  ...
  const epLabel =
    media.type === "TV" && media.progressSeason != null && media.progressEpisode != null
  ...
  return (
    <div
      className="group/card relative z-[1] w-[clamp(250px,70vw,306px)] shrink-0 snap-start cursor-pointer rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/80 focus-visible:ring-offset-2 focus-visible:ring-offset-[#18313d] sm:w-[clamp(300px,17vw,500px)]"
    ...
    >
      <div
        className="relative aspect-video overflow-hidden rounded-lg bg-card ring-1 ring-white/12 transition-shadow duration-200 group-hover/card:ring-white/22"
      >
        {showImg ? (
          <img
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-[#071720]/0 opacity-0 transition-[background-color,opacity] duration-200 group-hover/card:bg-[#071720]/18 group-hover/card:opacity-100 group-focus-within/card:opacity-100">
